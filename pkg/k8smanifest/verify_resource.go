...
func VerifyResource(obj unstructured.Unstructured, vo *VerifyResourceOption) (*VerifyResourceResult, error) {
	...
	manifestInRef, manifestFound, err = NewManifestFetcher(vo.ImageRef).Fetch(objBytes)
	if err != nil {
	...
	matched, diff, err := matchResourceWithManifest(obj, manifestInRef, ignoreFields)
	if err != nil {
